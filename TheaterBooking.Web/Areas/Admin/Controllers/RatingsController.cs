...
namespace TheaterBooking.Web.Areas.Admin.Controllers
{
    public class RatingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Rating_ID,Rating_Symbol")] Rating rating)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Rating_ID,Rating_Symbol")] Rating rating)
        {
            if (ModelState.IsValid)
            {
